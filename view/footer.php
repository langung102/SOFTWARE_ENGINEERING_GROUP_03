    <footer>
      <div class="d-flex p-2 flex-column flex-wrap align-content-center text-dark bg-white" >
        <div class="d-flex p-2 flex-md-row flex-column gap-3 flex-wrap align-content-center">
          ...
          <div style="padding-right: 1em;">
            ...
            <div style="text-align:left;"> 
              <img src="../asset/img/location-logo.png" class="me-2" alt="" width="40px">
              <i>Trường Đại học Bách khoa - ĐHQG TP.HCM</i>                
            </div>
            <div style="text-align:left;"> 
              <img src="../asset/img/work-time-logo.png" class="me-2" alt="" width="40px">
              <i>24/7</i>                
            </div>
            <div style="text-align:left;"> 
              <img src="../asset/img/phone-logo.png" class="me-2" alt="" width="40px">
              <i>(632)8-8888-627</i>                
            </div>
            <div style="text-align:left;"> 
              <img src="../asset/img/mail-logo.png" class="me-2" alt="" width="40px">
              <i>uwc2.0_nhom3@gmail.com</i>                
            </div>
          </div>
          <!-- ----------------------------------------------------------------------------------- -->
          <div style="padding: 0 4em 0 8em;"><br>
            ...
            <h6 style="text-align:left;" class="nav-item mb-2"> <a href="#" class="nav-link py-3">Về chúng tôi</a></h6>
            <h6 style="text-align:left;" class="nav-item mb-2"> <a href="#" class="nav-link py-3">Liên kết</a></h6>
          ...
          <div style="padding: 0 4em;"><br>
            ...
            <h6 style="text-align:left;" class="nav-item mb-2"> <a href="#" class="nav-link py-3">Chính sách riêng tư và bảo mật</a></h6>
          ...
          <div style="padding: 0 0 0 3em;"><br>
            ...
            <h6 style="text-align:center;" class="nav-item mb-2"> 
              <img height="50px" weight="50px" src="../asset/img/zalo_sharelogo.png"onclick="targetImage('https:\\zalo.me/pc')" style="cursor:pointer;" />
            </h6>
            <h6 style="text-align:center;" class="nav-item mb-2"> 
              <img height="50px" weight="50px" src="../asset/img/fb-logo.png"onclick="targetImage('https:\\www.facebook.com/')" style="cursor:pointer;" />
            </h6>
            <h6 style="text-align:center;" class="nav-item mb-2"> 
              <img height="50px" weight="50px" src="../asset/img/twitter-logo.png"onclick="targetImage('https:\\twitter.com/')" style="cursor:pointer;" />
            </h6>
            <h6 style="text-align:center;" class="nav-item mb-2"> 
              <img height="50px" weight="50px" src="../asset/img/instagram-logo.png"onclick="targetImage('https:\\www.instagram.com/')" style="cursor:pointer;" />
            </h6>
              <script>
        ...
        <div>
          <hr style="width:100%;"/>
          <p>Một sản phẩm của CNPM HK222 - Nhóm 3 </p>
          <p>Copyright © 2023 UWC 2.0 | Powered by UWC 2.0</p>
        </div>
      </div>
    </footer>
