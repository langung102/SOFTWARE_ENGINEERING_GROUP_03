                        ...
                        <div class="table100-head">
                            ...
                            <table id="tablemain">
                                <tbody id="tablemainbody">
                                    <tr id="row1">
                                        <td id="cell1" class="border" onclick="selectCell1(this)" style="cursor: pointer;"><input type = "hidden" name = "topic" value = "something"/><br></td>
...
//     ]).addTo(map);
    ...
    function zoomRoute(row) {
        ...
        // if (cell.childNodes[1].innerHTML != "<br>") {
        if (cell.childNodes[1].innerHTML != "") {
    ...
    function selected1(button) {
        ...
        flagDelete = 0;
        if (curRow.childNodes[1].innerHTML != "") {
            map.removeControl(lastRoute[curRow.childNodes[1].getAttribute("idroute")]);
            var tmp = 
            `<tr class="row100 body">
            <td class="cell100 column1">
    ...
    // $("#tablemain input[type='hidden']").change(function (event) {
    //     console.log("changed")
